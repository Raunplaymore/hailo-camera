  ...
  apps: [
    {
      ...
      env: {
        ...
        HAILO_MODEL_ALIASES: process.env.HAILO_MODEL_ALIASES || '',
        ...
        HAILO_POSTPROCESS_LIB: process.env.HAILO_POSTPROCESS_LIB || '',
        HAILO_POSTPROCESS_FUNC: process.env.HAILO_POSTPROCESS_FUNC || '',
        HAILO_PREVIEW_POSTPROCESS_FUNC: process.env.HAILO_PREVIEW_POSTPROCESS_FUNC || '',
